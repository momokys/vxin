  ...
  .carousel {
    ...
    .view {
      ...
      @keyframes plane-rotate {
        ...
        //  #{$index * 20}% {
        //    transform: rotateY(-#{$index * 60}deg);
        //  }
        //}
        0% {
      ...
      .card {
        ...
        @each $index in (1, 2, 3, 4, 5, 6) {
          &:nth-child(#{$index}) {
            ...
            //    transform: scaleZ(2) translate3d(0, 0, 300px) rotateY(#{($index - 1) * 60}deg);
            //  }
            //  100% {
            //    //transform: scaleZ(2) rotateY(#{($index - 1) * 60 - 360}deg) translateZ(300px);
            //    transform: scaleZ(2) translate3d(0, 0, 300px) rotateY(#{($index - 1) * 60 - 360}deg);
            //  }
            //}
          }
        }
        ...
        &:nth-child(1) {
          display: block;
          animation: self-action-1 10s infinite;
          @keyframes self-action-1 {
            0% {
              transform: scaleZ(2) translate3d(0, 0, 300px) rotateY(0deg);
            }
            100% {
              transform: scaleZ(2) translate3d(0, 0, 300px) rotateY(-360deg);
            }
          }
        }
        &:nth-child(2) {
          display: block;
          animation: self-action-2 10s infinite;
          @keyframes self-action-2 {
            0% {
              transform: scaleZ(2) translate3d(-300px, 0, 0) rotateY(0deg);
            }
            100% {
              transform: scaleZ(2) translate3d(-300px, 0, 0) rotateY(-360deg);
            }
          }
        }
      }
